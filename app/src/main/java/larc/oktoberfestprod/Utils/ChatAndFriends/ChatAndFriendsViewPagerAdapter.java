...
public class ChatAndFriendsViewPagerAdapter extends FragmentStatePagerAdapter  {
    ...
    ChatAndFriendTab1 tab1;
    ChatAndFriendTab2 tab2;
    boolean t1=false, t2=false;


    // Build a Constructor and assign the passed Values to appropriate values in the class
    public ChatAndFriendsViewPagerAdapter(FragmentManager fm,CharSequence mTitles[], int mNumbOfTabsumb) {
        super(fm);
